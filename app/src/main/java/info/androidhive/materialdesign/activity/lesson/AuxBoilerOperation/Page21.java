...
/**
 * Created by leo-pc on 1/23/2016.
 */
public class Page21 extends Fragment {

    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v =inflater.inflate(R.layout.layout_aux_boiler_operation_page21,container,false);
        ...
        img1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ly_image.setBackgroundResource(R.drawable.auxboiler_img14);
