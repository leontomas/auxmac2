...
public class Page19 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v =inflater.inflate(R.layout.layout_fresh_water_generator_page19,container,false);
        ...
        img1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ly_image.setBackgroundResource(R.drawable.freshwatergen_img26);
        ...
        img2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                LinearLayout ly_image =(LinearLayout)dialog.findViewById(R.id.ly_image);
                ly_image.setBackgroundResource(R.drawable.freshwatergen_img27);
