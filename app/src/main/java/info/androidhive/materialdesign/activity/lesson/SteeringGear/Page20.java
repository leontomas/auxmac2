...
public class Page20 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v =inflater.inflate(R.layout.layout_steering_gear_page20,container,false);
        ...
        img1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ly_image.setBackgroundResource(R.drawable.steeringgear_img12);
        ...
        img2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                LinearLayout ly_image =(LinearLayout)dialog.findViewById(R.id.ly_image);
                ly_image.setBackgroundResource(R.drawable.steeringgear_img13);
